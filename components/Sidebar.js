...
export default function Sidebar() {
  ...
  return (
    <aside
      className="flex flex-col border-r border-gray-800 transition-all duration-200 flex-shrink-0"
    ...
    >
      ...
      <div className="p-2">
        {navFijo.map(item => (
          <Link key={item.href} href={item.href}>
            <div className={`flex items-center gap-3 px-3 py-2 rounded-lg mb-1 cursor-pointer transition-all text-sm
      ...
      <div className="p-2 border-t border-gray-800">
        ...
        {navConfig.map(item => (
          <Link key={item.href} href={item.href}>
            <div className={`flex items-center gap-3 px-3 py-2 rounded-lg mb-1 cursor-pointer transition-all text-xs
